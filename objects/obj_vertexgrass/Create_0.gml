...
//Mode 1 variables
grass_radius = 45; //Radius around the object for creating the grass
//----------------

//Mode 2 variables (Size of the imaginary rectangle in which the grass is filled)
grass_rect_hor = 32; //Horizontal (x) size of rectangle
...
grass_random_image = false; //Can the grass use any sub-image from the sprite, at random? 
...
grass_wind = 0.2; //Power of the grass swaying
...
pattern_size = 4; //Sway pattern size
