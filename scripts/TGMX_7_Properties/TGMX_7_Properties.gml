...
function TPTarget(_target, _name) { return [TPTarget, is_struct(_target) ? weak_ref_create(_target) : _target, _name]; }
...
function TGMX_7_Properties()
{
	...
	{	/*
		...
		*/
		...
		case 5: _tween[TGMX_T_CALLER][$ _data[0]] = ceil(_value); break;
		case 6: _tween[TGMX_T_OTHER][$ _data[0]] = ceil(_value);  break;
		}
	});
	...
	{	
		...
		*/
		...
		case 5: _tween[TGMX_T_CALLER][$ _data[0]] = floor(_value);	break;
		case 6: _tween[TGMX_T_OTHER][$ _data[0]] = floor(_value);	break;
		}
	});
	...
	{	
		...
		*/
		...
		case 5: _tween[TGMX_T_CALLER][$ _data[0]] = round(_value);	break;
		case 6: _tween[TGMX_T_OTHER][$ _data[0]] = round(_value);	break;
		}
	});
	...
	{	
		...
		*/
		...
		case 5: _tween[TGMX_T_CALLER][$ _data[0]] = _value; break;
		case 6: _tween[TGMX_T_OTHER][$ _data[0]] = _value;	break;
		}
	});
	...
	function(_value, _target, _data, _tween)
	{
		...
		case 5: _tween[TGMX_T_CALLER][$ _data[0]] = merge_colour(_data[1], _data[2], _value); break;
		case 6: _tween[TGMX_T_OTHER][$ _data[0]] = merge_colour(_data[1], _data[2], _value);	break;
		}
	});
